        ...
        <>
            ...
            >
                ...
                <div className="px-8 pb-8">
                    <h1 className="text-xl font-black text-ink-base px-2 tracking-tighter uppercase">Hop In Express</h1>
                    <p className="text-[10px] font-bold text-primary px-2 tracking-[0.3em] uppercase opacity-80">Command OS</p>
                </div>
